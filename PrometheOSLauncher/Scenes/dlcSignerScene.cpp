...
void dlcSignerScene::render()
{
	...
	for (int i = 0; i < 3; i++)
	{
		drawing::drawBitmapStringAligned(context::getBitmapFontMedium(), "DLC / Update Signer...", i == 0 ? theme::getHeaderTextColor() : 0xff000000, theme::getHeaderAlign(), 39 + i, theme::getHeaderY(), 640);
	}
