...
void regionSettingsScene::render()
{
	...
	for (int i = 0; i < 3; i++)
	{
		drawing::drawBitmapStringAligned(context::getBitmapFontMedium(), "Region settings...", i == 0 ? theme::getHeaderTextColor() : 0xff000000, theme::getHeaderAlign(), 39 + i, theme::getHeaderY(), 640);
	}
