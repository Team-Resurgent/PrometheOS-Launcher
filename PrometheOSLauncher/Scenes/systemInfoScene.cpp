...
void systemInfoScene::render()
{
	...
	for (int i = 0; i < 3; i++)
	{
		if (mSystemInfoCategory == systemInfoCategoryConsole)
		{
			drawing::drawBitmapStringAligned(context::getBitmapFontMedium(), "System Info: Console", i == 1 ? theme::getHeaderTextColor() : 0xff000000, theme::getHeaderAlign(), 40, theme::getHeaderY(), 640);
		}
		else if (mSystemInfoCategory == systemInfoCategoryStorage)
		{
			drawing::drawBitmapStringAligned(context::getBitmapFontMedium(), "System Info: Storage", i == 1 ? theme::getHeaderTextColor() : 0xff000000, theme::getHeaderAlign(), 40, theme::getHeaderY(), 640);
		}
		else if (mSystemInfoCategory == systemInfoCategoryAudio)
		{
			drawing::drawBitmapStringAligned(context::getBitmapFontMedium(), "System Info: Audio", i == 1 ? theme::getHeaderTextColor() : 0xff000000, theme::getHeaderAlign(), 40, theme::getHeaderY(), 640);
		}
		else if (mSystemInfoCategory == systemInfoCategoryVideo)
		{
			drawing::drawBitmapStringAligned(context::getBitmapFontMedium(), "System Info: Video", i == 1 ? theme::getHeaderTextColor() : 0xff000000, theme::getHeaderAlign(), 40, theme::getHeaderY(), 640);
		}
		else if (mSystemInfoCategory == systemInfoCategoryAbout)
		{
			drawing::drawBitmapStringAligned(context::getBitmapFontMedium(), "System Info: About", i == 1 ? theme::getHeaderTextColor() : 0xff000000, theme::getHeaderAlign(), 40, theme::getHeaderY(), 640);
		}
	}
