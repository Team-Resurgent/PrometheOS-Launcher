...
// This must match enum from:
// https://github.com/Team-Resurgent/Modxo/blob/main/src/modxo/modxo_ports.h#L36
typedef enum
{
...
char* modchipModxo::getName() {
	uint8_t variantId = inputByte(MODXO_REGISTER_VARIANT_ID);
	char *variantName = "";

	switch(variantId) {
		case MODXO_VARIANT_OFFICIAL_PICO: variantName    = "Official Pico"; break;
		case MODXO_VARIANT_OFFICIAL_PICO2: variantName   = "Official Pico2"; break;
		case MODXO_VARIANT_RP2040_ZERO_TINY: variantName = "RP2040 Zero & Tiny"; break;
		case MODXO_VARIANT_YD_RP2040: variantName        = "YD-RP2040"; break;
		case MODXO_VARIANT_XIAO_RP2040: variantName      = "XIAO-RP2040"; break;
		case MODXO_VARIANT_ULTRA: variantName            = "Ultra"; break;
	}

	return stringUtility::formatString("ModXo (%s)", variantName);
}
